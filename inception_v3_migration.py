...
def get_test_bottlenecks(sess, image_lists, n_classes,
    ...
    for label_index, label_name in enumerate(label_name_list):
        category = 'testing'
        for index, unused_base_name in enumerate(image_lists[label_name_list][category]):
...
def main(_):
    ...
    # 定义交叉熵损失函数
    cross_entropy = tf.nn.softmax_cross_entropy_with_logits(logits, ground_trunth_input)
